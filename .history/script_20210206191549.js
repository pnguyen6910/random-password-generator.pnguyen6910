...
generatePassword => {
  ...
  if (!firstPrompt) {
    ...
    askNoCap => {
      const askCapP = prompt("Would you like to add lowercase letters to the password? Y/N")
      upperQ = askCapP.toLocaleLowerCase()
      if (askCapP != "y" && askCapP != "n") {
        alert("Please enter Y or N")
        askCapP()
    ...
    askNum => {
      const askCapP = prompt("Would you like to add numbers to the password? Y/N")
      upperQ = askCapP.toLocaleLowerCase()
      if (askCapP != "y" && askCapP != "n") {
        alert("Please enter Y or N")
        askCapP()
    ...
    askSpecial => {
      const askCapP = prompt("Would you like to add special characters to the password? Y/N")
      upperQ = askCapP.toLocaleLowerCase()
      if (askCapP != "y" && askCapP != "n") {
        alert("Please enter Y or N")
        askCapP()
